class cfgWeapons {
    ...
    class MNP_CombatUniform_Ranger_A : Uniform_Base {
        ...
        class ItemInfo : UniformItem {
            modelSides[] = {6};
            uniformModel = "-";
            uniformClass = "MNP_USACU_Soldier_F"; //would be same as our made soldier class
    ...
    class MNP_CombatUniform_Ranger_B : Uniform_Base {
        ...
        class ItemInfo : UniformItem {
            modelSides[] = {6};
            uniformModel = "-";
            uniformClass = "MNP_USACU_Soldier_AR"; //would be same as our made soldier class
            containerClass = "Supply100"; //how much it can carry
            mass = 10; //how much it weights
            hiddenSelections[] = {"Camo"};
        };
    ...
    class MNP_CombatUniform_Ranger_C : Uniform_Base {
        ...
        class ItemInfo : UniformItem {
            modelSides[] = {6};
            uniformModel = "-";
            uniformClass = "MNP_USACU_Soldier_M"; //would be same as our made soldier class
            containerClass = "Supply100"; //how much it can carry
            mass = 10; //how much it weights
            hiddenSelections[] = {"Camo"};
        };
    ...
    class MNP_CombatUniform_Ranger_E : Uniform_Base {
        ...
        class ItemInfo : UniformItem {
            modelSides[] = {6};
            uniformModel = "-";
            uniformClass = "MNP_USACU_Soldier_MG"; //would be same as our made soldier class
            containerClass = "Supply100"; //how much it can carry
            mass = 10; //how much it weights
            hiddenSelections[] = {"Camo"};
        };
    ...
    class MNP_CombatUniform_DS_A : Uniform_Base {
        ...
        class ItemInfo : UniformItem {
            modelSides[] = {6};
            uniformModel = "-";
            uniformClass = "MNP_US_MC_Soldier_F"; //would be same as our made soldier class
            containerClass = "Supply100"; //how much it can carry
            mass = 10; //how much it weights
            hiddenSelections[] = {"Camo"};
        };
    ...
    class MNP_CombatUniform_DS_B : Uniform_Base {
        ...
        class ItemInfo : UniformItem {
            modelSides[] = {6};
            uniformModel = "-";
            uniformClass = "MNP_US_MC_Soldier_AR"; //would be same as our made soldier class
            containerClass = "Supply100"; //how much it can carry
            mass = 10; //how much it weights
            hiddenSelections[] = {"Camo"};
        };
